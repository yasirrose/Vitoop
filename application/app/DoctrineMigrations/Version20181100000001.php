...
class Version20181100000001 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE options IF NOT EXISTS (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(100) NOT NULL, value VARCHAR(10000) NOT NULL, UNIQUE INDEX UNIQ_D035FA875E237E06 (name), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE resource IF NOT EXISTS (id INT AUTO_INCREMENT NOT NULL, id_user INT DEFAULT NULL, language VARCHAR(2) DEFAULT NULL, country VARCHAR(2) DEFAULT NULL, name VARCHAR(160) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, doctrine2_dc SMALLINT NOT NULL, INDEX IDX_BC91F4166B3CA4B (id_user), INDEX IDX_BC91F416D4DB71B5 (language), INDEX IDX_BC91F4165373C966 (country), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE pdf IF NOT EXISTS (id INT NOT NULL, author VARCHAR(128) NOT NULL, publisher VARCHAR(128) NOT NULL, url VARCHAR(255) NOT NULL, tnop INT NOT NULL, last_checked_at DATETIME DEFAULT NULL, is_skip TINYINT(1) DEFAULT \'0\' NOT NULL, is_downloaded SMALLINT DEFAULT 0 NOT NULL, downloaded_at DATETIME DEFAULT NULL, pdf_date VARCHAR(10) NOT NULL, pdf_order BIGINT DEFAULT NULL, UNIQUE INDEX UNIQ_EF0DB8CF47645AE (url), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE remark_private IF NOT EXISTS (id INT AUTO_INCREMENT NOT NULL, id_user INT DEFAULT NULL, id_resource INT DEFAULT NULL, created_at DATETIME NOT NULL, text VARCHAR(2048) NOT NULL, INDEX IDX_127F6656B3CA4B (id_user), INDEX IDX_127F665EC4A1883 (id_resource), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE languages IF NOT EXISTS (code VARCHAR(2) NOT NULL, name VARCHAR(255) NOT NULL, sort_order INT DEFAULT NULL, PRIMARY KEY(code)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE pdf_annotation IF NOT EXISTS (id INT AUTO_INCREMENT NOT NULL, pdf_id INT DEFAULT NULL, user_id INT DEFAULT NULL, annotations LONGTEXT NOT NULL COMMENT \'(DC2Type:json_array)\', INDEX IDX_1479CCC4511FC912 (pdf_id), INDEX IDX_1479CCC4A76ED395 (user_id), UNIQUE INDEX uniqpdfannot_idx (pdf_id, user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE rel_resource_resource IF NOT EXISTS (id INT AUTO_INCREMENT NOT NULL, id_resource1 INT DEFAULT NULL, id_resource2 INT DEFAULT NULL, id_user INT DEFAULT NULL, deleted_by_id_user INT DEFAULT NULL, coefficient DOUBLE PRECISION DEFAULT \'0\' NOT NULL, INDEX IDX_BB65537CF7817735 (id_resource1), INDEX IDX_BB65537C6E88268F (id_resource2), INDEX IDX_BB65537C6B3CA4B (id_user), INDEX IDX_BB65537C5D2FB0A4 (deleted_by_id_user), UNIQUE INDEX uniquerelresres_idx (id_resource1, id_resource2, id_user), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE project_data IF NOT EXISTS (id INT AUTO_INCREMENT NOT NULL, sheet MEDIUMTEXT NOT NULL, is_private TINYINT(1) DEFAULT \'0\' NOT NULL, is_for_related_users TINYINT(1) DEFAULT \'0\' NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE countries IF NOT EXISTS (code VARCHAR(2) NOT NULL, name VARCHAR(255) NOT NULL, sort_order INT DEFAULT NULL, PRIMARY KEY(code)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE address IF NOT EXISTS (id INT NOT NULL, name2 VARCHAR(64) NOT NULL, street VARCHAR(64) NOT NULL, zip VARCHAR(5) NOT NULL, city VARCHAR(64) NOT NULL, contact1 VARCHAR(32) NOT NULL, contact2 VARCHAR(32) NOT NULL, contact3 VARCHAR(32) NOT NULL, contact4 VARCHAR(128) NOT NULL, contact5 VARCHAR(128) NOT NULL, contact_key VARCHAR(5) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE users_resources IF NOT EXISTS (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, resource_id INT DEFAULT NULL, created_at DATETIME DEFAULT NULL, INDEX IDX_891B914FA76ED395 (user_id), INDEX IDX_891B914F89329D25 (resource_id), UNIQUE INDEX uniqueusersres_idx (resource_id, user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user_config IF NOT EXISTS (id INT AUTO_INCREMENT NOT NULL, max_per_page INT NOT NULL, number_of_todo_elements INT DEFAULT 12 NOT NULL, height_of_todo_list INT DEFAULT 550 NOT NULL, is_check_max_link TINYINT(1) DEFAULT \'1\' NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE vitoop_blog IF NOT EXISTS (id INT AUTO_INCREMENT NOT NULL, sheet MEDIUMTEXT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE project IF NOT EXISTS (id INT NOT NULL, project_data_id INT DEFAULT NULL, description TEXT NOT NULL, UNIQUE INDEX UNIQ_2FB3D0EEA1EBAD59 (project_data_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE wiki_redirect IF NOT EXISTS (wiki_page_id INT NOT NULL, id_lexicon INT DEFAULT NULL, wiki_title VARCHAR(128) NOT NULL, wiki_fullurl VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_28CA9BE484BC41E7 (wiki_title), UNIQUE INDEX UNIQ_28CA9BE4C0D3845D (wiki_fullurl), INDEX IDX_28CA9BE4DAAC93BF (id_lexicon), PRIMARY KEY(wiki_page_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE flag IF NOT EXISTS (id INT AUTO_INCREMENT NOT NULL, id_user INT DEFAULT NULL, id_resource INT DEFAULT NULL, created_at DATETIME NOT NULL, type SMALLINT NOT NULL, info VARCHAR(128) NOT NULL, INDEX IDX_D1F4EB9A6B3CA4B (id_user), INDEX IDX_D1F4EB9AEC4A1883 (id_resource), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE users_readable IF NOT EXISTS (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, resource_id INT DEFAULT NULL, created_at DATETIME DEFAULT NULL, INDEX IDX_BADB323AA76ED395 (user_id), INDEX IDX_BADB323A89329D25 (resource_id), UNIQUE INDEX uniqueusersred_idx (resource_id, user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE help IF NOT EXISTS (id INT AUTO_INCREMENT NOT NULL, text VARCHAR(10000) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE vitoop_user_agreement IF NOT EXISTS (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, ip VARCHAR(30) DEFAULT NULL, created_at DATETIME NOT NULL, INDEX IDX_877039E7A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE tag IF NOT EXISTS (id INT AUTO_INCREMENT NOT NULL, text VARCHAR(48) NOT NULL, UNIQUE INDEX UNIQ_389B7833B8BA7C7 (text), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE watchlist IF NOT EXISTS (id INT AUTO_INCREMENT NOT NULL, id_user INT DEFAULT NULL, id_resource INT DEFAULT NULL, note VARCHAR(255) NOT NULL, INDEX IDX_340388D36B3CA4B (id_user), INDEX IDX_340388D3EC4A1883 (id_resource), UNIQUE INDEX uniqueentry_idx (id_resource, id_user), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE remark IF NOT EXISTS (id INT AUTO_INCREMENT NOT NULL, id_user INT DEFAULT NULL, id_resource INT DEFAULT NULL, created_at DATETIME NOT NULL, text VARCHAR(2048) NOT NULL, ip VARCHAR(30) DEFAULT NULL, is_locked TINYINT(1) NOT NULL, INDEX IDX_E1CAD8396B3CA4B (id_user), INDEX IDX_E1CAD839EC4A1883 (id_resource), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE link IF NOT EXISTS (id INT NOT NULL, url VARCHAR(255) NOT NULL, is_hp TINYINT(1) NOT NULL, last_checked_at DATETIME DEFAULT NULL, is_skip TINYINT(1) DEFAULT \'0\' NOT NULL, UNIQUE INDEX UNIQ_36AC99F1F47645AE (url), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE vitoop_user IF NOT EXISTS (id INT AUTO_INCREMENT NOT NULL, user_config_id INT DEFAULT NULL, user_data_id INT DEFAULT NULL, username VARCHAR(25) NOT NULL, email VARCHAR(60) NOT NULL, password VARCHAR(40) NOT NULL, reset_password_token VARCHAR(255) DEFAULT NULL, salt VARCHAR(40) NOT NULL, is_active TINYINT(1) NOT NULL, is_agreed_with_terms TINYINT(1) DEFAULT \'1\' NOT NULL, is_show_help TINYINT(1) DEFAULT \'1\' NOT NULL, last_logined_at DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_942E46AAF85E0677 (username), UNIQUE INDEX UNIQ_942E46AAE7927C74 (email), UNIQUE INDEX UNIQ_942E46AA243B8B67 (user_config_id), UNIQUE INDEX UNIQ_942E46AA6FF8BF36 (user_data_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE book IF NOT EXISTS (id INT NOT NULL, author VARCHAR(256) NOT NULL, publisher VARCHAR(256) NOT NULL, issuer VARCHAR(256) DEFAULT NULL, kind VARCHAR(100) NOT NULL, isbn VARCHAR(17) NOT NULL, tnop INT NOT NULL, year VARCHAR(20) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE vitoop_user_invitation IF NOT EXISTS (id INT AUTO_INCREMENT NOT NULL, id_user INT DEFAULT NULL, subject VARCHAR(64) NOT NULL, mail VARCHAR(4096) NOT NULL, email VARCHAR(60) NOT NULL, secret VARCHAR(32) NOT NULL, until DATETIME NOT NULL, UNIQUE INDEX UNIQ_F3D9E7CBE7927C74 (email), UNIQUE INDEX UNIQ_F3D9E7CB5CA2E8E5 (secret), INDEX IDX_F3D9E7CB6B3CA4B (id_user), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE rel_project_user IF NOT EXISTS (id INT AUTO_INCREMENT NOT NULL, id_project_data INT DEFAULT NULL, id_user INT DEFAULT NULL, read_only TINYINT(1) DEFAULT \'1\' NOT NULL, INDEX IDX_82C10239B7A34E09 (id_project_data), INDEX IDX_82C102396B3CA4B (id_user), UNIQUE INDEX uniquerelprjusr_idx (id_project_data, id_user), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE rating IF NOT EXISTS (id INT AUTO_INCREMENT NOT NULL, id_user INT DEFAULT NULL, id_resource INT DEFAULT NULL, mark INT NOT NULL, INDEX IDX_D88926226B3CA4B (id_user), INDEX IDX_D8892622EC4A1883 (id_resource), UNIQUE INDEX uniquerating_idx (id_resource, id_user), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE lexicon IF NOT EXISTS (id INT NOT NULL, wiki_page_id INT NOT NULL, wiki_fullurl VARCHAR(255) NOT NULL, description VARCHAR(5000) NOT NULL, updated DATETIME NOT NULL, UNIQUE INDEX UNIQ_4313ACFC4759321 (wiki_page_id), UNIQUE INDEX UNIQ_4313ACFC0D3845D (wiki_fullurl), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE project_rel_divider IF NOT EXISTS (id INT AUTO_INCREMENT NOT NULL, id_project_data INT DEFAULT NULL, text VARCHAR(350) DEFAULT NULL, coefficient INT NOT NULL, INDEX IDX_8D788647B7A34E09 (id_project_data), UNIQUE INDEX uniqueprjreldiv_idx (coefficient, id_project_data), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE teli IF NOT EXISTS (id INT NOT NULL, url VARCHAR(255) NOT NULL, author VARCHAR(128) NOT NULL, last_checked_at DATETIME DEFAULT NULL, is_skip TINYINT(1) DEFAULT \'0\' NOT NULL, is_downloaded SMALLINT DEFAULT 0 NOT NULL, downloaded_at DATETIME DEFAULT NULL, release_date VARCHAR(10) NOT NULL, release_order BIGINT DEFAULT NULL, UNIQUE INDEX UNIQ_76231C4BF47645AE (url), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE rel_resource_tag IF NOT EXISTS (id INT AUTO_INCREMENT NOT NULL, id_resource INT DEFAULT NULL, id_tag INT DEFAULT NULL, id_user INT DEFAULT NULL, deleted_by_id_user INT DEFAULT NULL, INDEX IDX_151325A2EC4A1883 (id_resource), INDEX IDX_151325A29D2D5FD9 (id_tag), INDEX IDX_151325A26B3CA4B (id_user), INDEX IDX_151325A25D2FB0A4 (deleted_by_id_user), UNIQUE INDEX uniquetag_idx (id_resource, id_tag, id_user), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE comment IF NOT EXISTS (id INT AUTO_INCREMENT NOT NULL, id_user INT DEFAULT NULL, id_resource INT DEFAULT NULL, text VARCHAR(512) NOT NULL, created_at DATETIME NOT NULL, is_visible TINYINT(1) DEFAULT \'1\' NOT NULL, INDEX IDX_9474526C6B3CA4B (id_user), INDEX IDX_9474526CEC4A1883 (id_resource), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user_data IF NOT EXISTS (id INT AUTO_INCREMENT NOT NULL, sheet MEDIUMTEXT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE to_do_item ADD sort_order INT DEFAULT 0 NOT NULL');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE to_do_item DROP sort_order');
    }
}
