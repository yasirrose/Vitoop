...
class Version20181100000001 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE IF NOT EXISTS pdf_annotation (id INT AUTO_INCREMENT NOT NULL, pdf_id INT DEFAULT NULL, user_id INT DEFAULT NULL, annotations JSON NOT NULL, INDEX IDX_1479CCC4511FC912 (pdf_id), INDEX IDX_1479CCC4A76ED395 (user_id), UNIQUE INDEX uniqpdfannot_idx (pdf_id, user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
