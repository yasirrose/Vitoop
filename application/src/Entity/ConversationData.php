 ...
 * @ORM\Entity(repositoryClass="App\Repository\ConversationDataRepository")
 */
class ConversationData implements GetDTOInterface
{
    ...
    /**
     * @ORM\ManyToMany(targetEntity="App\Entity\User\User", cascade = {"persist", "merge", "remove"}, fetch="EXTRA_LAZY")
     ...
     */
    public function addMessage(\App\Entity\ConversationMessage $message)
    {
     ...
     * @param \App\Entity\ConversationMessage $message
     */
    public function removeMessage(\App\Entity\ConversationMessage $message)
    {
        if ($this->messages->contains($message)) {
     ...
     * Add relUsers
     *
     * @param \App\Entity\RelConversationUser $relUser
     * @return ConversationData
     */
    public function addRelUser(\App\Entity\RelConversationUser $relUser)
    {
     ...
     * @param \App\Entity\RelConversationUser $relUser
     */
    public function removeRelUser(\App\Entity\RelConversationUser $relUser)
    {
