...
use App\Validator\Constraints\DateFormat as DateFormatAssert;
use App\DTO\Resource\ResourceDTO;
use App\Entity\Downloadable\DownloadableInterface;

/**
 * @ORM\Table(name="teli")
 * @ORM\Entity(repositoryClass="App\Repository\TeliRepository")
 */
class Teli extends Resource implements DownloadableInterface, UrlCheckInterface
{
    use \App\Entity\UrlCheck\UrlCheckTrait;
    use \App\Entity\Downloadable\DownloadableTrait;
    ...
    /**
     * @ORM\Embedded(class="App\Entity\ValueObject\PublishedDate", columnPrefix="release_")
     * @Assert\NotBlank
     * @DateFormatAssert
     */
