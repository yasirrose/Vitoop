 ...
 */
class RelResourceResourceRepository extends ServiceEntityRepository
{
    public function __construct(ManagerRegistry $registry)
    {
        parent::__construct($registry, RelResourceResource::class);
    }
    ...
    public function remove(RelResourceResource $relResourceResource)
    {
        $this->_em->remove($relResourceResource);
        $this->_em->flush($relResourceResource);
    }
